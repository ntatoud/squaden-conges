    ...
    variants: {
      variant: {
        ...
        secondary:
          ...
          '[a:hover_&:not([data-action])]:bg-accent [a:hover_&:not([data-action])]:text-accent-foreground' +
          'dark:[a:hover_&:not([data-action])]:bg-accent dark:[a:hover_&:not([data-action])]:text-accent-foreground' +
        ...
        'destructive-secondary':
          'border border-input bg-background text-negative-600 shadow-xs hover:border-transparent hover:bg-destructive/90 hover:text-destructive-foreground ' +
          'dark:text-negative-400 dark:hover:text-destructive-foreground' +
          '[a:hover_&:not([data-action])]:bg-destructive/90 [a:hover_&:not([data-action])]:text-destructive-foreground' +
          'dark:[a:hover_&:not([data-action])]:bg-destructive/90 dark:[a:hover_&:not([data-action])]:text-destructive-foreground' +
          '[button:hover_&]:bg-destructive/90 [button:hover_&]:text-destructive-foreground' +
          'dark:[button:hover_&]:bg-destructive/90 dark:[button:hover_&]:text-destructive-foreground',
